...
function runCustomTests() {
  ...
  var px_data_table_1, px_data_table_2, px_data_table_3, px_data_table_4, px_data_table_5;
  var data =
  [
    {
      "index": 0,
  ...
  px_data_table_1 = document.getElementById('px_data_table_1');
  px_data_table_1.tableData = data;

  px_data_table_2 = document.getElementById('px_data_table_2');
  px_data_table_2.tableData = minidata;

  px_data_table_3 = document.getElementById('px_data_table_3');
  px_data_table_3.tableData = data;

  px_data_table_4 = document.getElementById('px_data_table_4');
  px_data_table_4.tableData = data;

  px_data_table_5 = document.getElementById('px_data_table_5');
  px_data_table_5.tableData = data;

  // This is the placeholder suite that the developer should put
  // custom tests in
  suite('Custom Automation Tests for px-data-table', function() {

    test('px_data_table_2 fixture is created', function() {
      assert.isTrue(document.getElementById('px_data_table_2') !== null);
    });
    test('px_data_table_3 fixture is created', function() {
      assert.isTrue(document.getElementById('px_data_table_3') !== null);
    });
    test('px_data_table_4 fixture is created', function() {
      assert.isTrue(document.getElementById('px_data_table_4') !== null);
    });
    test('px_data_table_5 fixture is created', function() {
      assert.isTrue(document.getElementById('px_data_table_5') !== null);
    });

    // Spot checks for correct table structure, cell values and control states
    /*
    test('There should be 17 columns in the px_data_table_1 fixture', function() {
    ...
    */
    ...
    testCase({
      description : 'There should be 17 columns in the px_data_table_1 fixture',
    ...
    test('Value of 5th data row 2nd column of first table should be "Rita Lopez"', function() {
      var fixture = document.getElementById('px_data_table_1');
    ...
    */
    ...
    test('First Name displays only first 10 characters  if length of the text is greater than 10 characters and elipse at the right', function() {
      var fixture = document.getElementById('px_data_table_5');
    ...
    */
    ...
    test('Matching records are returned when filter text is entered', function(done) {
      var filterableTableRoot = document.querySelector('#px_data_table_2');
    ...
    */
    ...
    testCase({
      description: 'Matching records are returned when filter text is entered',
      root: '#px_data_table_2',
      eventSource: 'div > div.tr.tr--filter > :nth-child(3) > input',
      event: 'keyup',
      modifyFunction: function(rootElement) {
        var lastNameFilter = rootElement.querySelector('div > div.tr.tr--filter > :nth-child(3) > input');
        lastNameFilter.value = 'wo';
      },
      assertFunction: function(rootElement) {
        var secondReturnedRowFirstNameSelector = '#dataTable :nth-child(4) .aha-first-td';
        var secondReturnedRowFirstName = rootElement.querySelector(secondReturnedRowFirstNameSelector);
        return (secondReturnedRowFirstName.innerHTML.indexOf('Rita') >= 0);
      }
    });
    ...
    test('Records are sorted correctly when a sortable column header is clicked', function(done) {
      var sortableTableRoot = document.querySelector('#px_data_table_1');
